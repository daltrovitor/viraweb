...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Amber Converter badge */}
        <div className="hero-badge inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#D97706]/10 text-[#D97706] text-xs font-bold uppercase tracking-wider mb-8 border border-[#D97706]/20">
          <Sparkles className="w-3.5 h-3.5" />
          ARQUITETURA DIGITAL & ENGENHARIA DE ELITE
        </div>
        ...
        <h1 className="hero-title text-4xl sm:text-6xl md:text-7xl font-black text-[#0F172A] tracking-tighter leading-[0.95] mb-8">
          <span className="font-light italic text-2xl sm:text-4xl md:text-5xl block text-[#475569] mb-4">
            Código de Elite. Escala Sustentável.
          </span>
