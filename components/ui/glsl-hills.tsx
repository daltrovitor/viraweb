...
export function GLSLHills({
  ...
  planeSize = 256,
  speed = 0.5,
  lineColorHex = '#CBD5E1', // light slate line color for architectural grid look
}: GLSLHillsProps) {
  ...
  useEffect(() => {
    ...
    const colorObj = new THREE.Color(lineColorHex);
    ...
    const resize = () => {
      ...
      camera.aspect = widthVal / heightVal;
  ...
  }, [cameraZ, planeSize, speed, lineColorHex]);
